...
<%	}else{
		...
		if(option == null || option.equals("0")){
			...
			if(request.getParameter("sDayReview") != null){
				sDayReview = Integer.parseInt(request.getParameter("sDayReview"));
			}
...
<%				if(option.equals("3") && session.getAttribute("sid").equals("admin")){
					...
					response.sendRedirect("/wouldyoulike_final/admin/board/list.jsp?option=2&sday=" + sday + "&haveReply=" + haveReply);
