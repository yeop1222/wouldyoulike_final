...
<%
	String dir = request.getRealPath("/img/board/prodqnaimage/");
...
<%			if(option == 3 && session.getAttribute("sid").equals("admin")){
				...
				response.sendRedirect("/wouldyoulike_final/admin/board/read.jsp?option=0&sday=" + sday + "&haveReply=" + haveReply + "&boardnum=" + dto.getOriginalnum());
			} else if(option==2){
