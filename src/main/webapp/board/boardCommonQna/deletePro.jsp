...
<%	}else{
		...
		if("1".equals(option)){
			...
			if(request.getParameter("sDayCommon") != null){
				sDayCommon = Integer.parseInt(request.getParameter("sDayCommon"));
			}
...
<%				if(option.equals("3") && session.getAttribute("sid").equals("admin")){
					...
					response.sendRedirect("/wouldyoulike_final/admin/board/list.jsp?option=1&sday=" +sday + "&haveReply= " + haveReply);
